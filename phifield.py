...
a1 = st.sidebar.slider('Select value for a1', -500.0, 500.0, 1,  key='a1')
b1 = st.sidebar.slider('Select value for b1', -500.0, 500.0, 1,  key='b1')
c1 = st.sidebar.slider('Select value for c1', -500.0, 500.0, 1,  key='c1')
...
a2 = st.sidebar.slider('Select value for a2', -500.0, 500.0, 1,  key='a2')
b2 = st.sidebar.slider('Select value for b2', -500.0, 500.0, 1,  key='b2')
c2 = st.sidebar.slider('Select value for c2', -500.0, 500.0, 1,  key='c2')
...
a3 = st.sidebar.slider('Select value for a3', -500.0, 500.0, 1,  key='a3')
b3 = st.sidebar.slider('Select value for b3', -500.0, 500.0, 1,  key='b3')
c3 = st.sidebar.slider('Select value for c3', -500.0, 500.0, 1,  key='c3')

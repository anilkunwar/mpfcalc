...
####################################################################
st.write("The model parameters $\kappa$ and $MU$ of the phase field models are expressed as  the functions of interface energy ($\sigma$) and diffuse interface width $\delta$),
         i.e. )
